...
#Demanda Barra 2 - entre 23 e 27
D2 = [26, 26, 24, 23, 25, 23, 24, 23, 23, 25, 23, 23, 25, 24, 26, 25, 26, 26, 25, 26] #D2 = np.random.randint(23,27, size=(20))
#Demanda Barra 3 - entre 20 e 30
D3 = [20, 22, 21, 21, 24, 24, 29, 25, 26, 26, 20, 24, 21, 28, 20, 22, 22, 26, 29, 29] #D3 = np.random.randint(20,30, size=(20))
#Afluência - entre 0 e 100
afl = [72, 54, 77,  1, 26, 35, 81, 1,  7,  0, 48, 85, 78, 93, 61, 78, 69, 90, 52, 16] #afl = np.random.randint(0,100, size=(20))
print(D2)
print(D3)
print(afl)
...
def roda_caso(D1,D2,D3,afl):
	...
	f12 = m.addVar(lb=-15, ub=15, name="Fluxo lt:1-2") #f3
	f31 = m.addVar(lb=-15,ub=15,name="Fluxo lt:3-1") #f1
	f23 = m.addVar(lb=-10,ub=10,name="Fluxo lt:2-3") #f2
...
##cria dataframe
header = ['gt1','gt2','gt3','alfa','v', 'y','s','q','f12','f31','f23','_f_','cmo_1','cmo_2','cmo_3']
